...
class DummyRepositoryTest constructor(
    ...
    override fun getAllMovies(): LiveData<ResourceStatus<PagedList<MovieModel>>> {
        return object : BoundServiceNetwork<PagedList<MovieModel>, List<Movie>>(appExecutors) {
    ...
    override fun getDetailMovies(id: Int): LiveData<ResourceStatus<MovieModel>> {
        ...
        return object : BoundServiceNetwork<MovieModel, MovieDetail>(appExecutors) {
    ...
    override fun getAllTvShow(): LiveData<ResourceStatus<PagedList<TvShowModel>>> {
        ...
        return object : BoundServiceNetwork<PagedList<TvShowModel>, List<TvShow>>(appExecutors) {
    ...
    override fun getDetailTvShow(id: Int): LiveData<ResourceStatus<TvShowModel>> {
        ...
        return object : BoundServiceNetwork<TvShowModel, TvShowDetail>(appExecutors) {
